---
title: "Schedule"
date: 2026-05-04T13:27:57+02:00
draft: false
---

<!-- <center><h2>(<a href="/program/overview">Schedule Overview</a>)</h2></center> -->

<!--<div style="background-color: #fff4e6; border-left: 4px solid #f5821f; padding: 15px; margin: 20px 0; border-radius: 5px;">
<strong>Please note:</strong> Below is the draft assignment of accepted papers to sessions, intended to give authors an idea of when their presentation will take place. Precise timings of individual sessions will be published in due course.
</div>-->
...
<a href="#sunday" style="background-color: #f5821f; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px; font-weight: bold; transition: background-color 0.3s;">Sunday 28/06</a>
<a href="#monday" style="background-color: #f5821f; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px; font-weight: bold; transition: background-color 0.3s;">Monday 29/06</a>
<a href="#tuesday" style="background-color: #f5821f; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px; font-weight: bold; transition: background-color 0.3s;">Tuesday 30/06</a>
<a href="#wednesday" style="background-color: #f5821f; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px; font-weight: bold; transition: background-color 0.3s;">Wednesday 01/07</a>
<a href="#thursday" style="background-color: #f5821f; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px; font-weight: bold; transition: background-color 0.3s;">Thursday 02/07</a>
</div>
</div>
...
<h2 style="margin: 0; font-size: 1.8em;">Monday, June 29, 2026 — Workshops & Tutorials Day 2
<a href="#top" style="color: white; text-decoration: none; font-size: 0.6em; margin-left: 10px; opacity: 0.8;">↑ Back to Navigation</a></h2>
</div>
...
<div class="special-event">Opening Reception (17:30 – 19:30) — Fitzwilliam Suites &amp; Pre-Function Area</div>

---

<div id="tuesday" style="text-align: center; background-color: #f5821f; color: white; padding: 15px; margin: 20px 0; border-radius: 8px;">
<h2 style="margin: 0; font-size: 1.8em;">Tuesday, June 30, 2026 — Main Conference Day 1
<a href="#top" style="color: white; text-decoration: none; font-size: 0.6em; margin-left: 10px; opacity: 0.8;">↑ Back to Navigation</a></h2>
</div>
...
<h2 style="margin: 0; font-size: 1.8em;">Wednesday, July 1, 2026 — Main Conference Day 2
<a href="#top" style="color: white; text-decoration: none; font-size: 0.6em; margin-left: 10px; opacity: 0.8;">↑ Back to Navigation</a></h2>
</div>
...
<h2 style="margin: 0; font-size: 1.8em;">Thursday, July 2, 2026 — Main Conference Day 3
<a href="#top" style="color: white; text-decoration: none; font-size: 0.6em; margin-left: 10px; opacity: 0.8;">↑ Back to Navigation</a></h2>
</div>
